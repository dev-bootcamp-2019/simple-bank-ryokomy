...
contract SimpleBank {
    ...
    event LogWithdrawal(address indexed accountAddress, uint newBalance, uint withdrawAmount);
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        ...
        require(balances[msg.sender] >= withdrawAmount, "The user's balance is not enough");
